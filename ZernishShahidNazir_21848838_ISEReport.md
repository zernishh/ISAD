...
#### ValidateInputTest
![test1 result](ValidateInputTest.png)

#### FindSeasonTest
![test2 result](FindSeasonTest.png)

#### ValidateTemperatureTest
![test3 result](ValidateTemperatureTest.png)

#### CompareTemperatureTest
![test4 result](CompareTemperatureTest.png)
...
![test5 result](GetDailyMeanTemperatureTest.png)
...
![docLog](gitLogDocumentation.png)

#### Git log **Code**
![codeLog](gitLogCode.png)
